...
inline Vector3f RGB2XYZ(Vector3f src) {
  Vector3f dst;
...
inline Vector3f XYZ2RGB(Vector3f src) {
  Vector3f dst;
...
inline Vector3f XYZ2Lab(Vector3f src) {
...
inline Vector3f Lab2XYZ(Vector3f src) {
  src[0] *= 100;
  src[1] *= 127;
  src[2] *= 127;
  constexpr Float d = 6.0 / 29.0;
...
inline Vector3f Lab2LCH(Vector3f src) {
  Float l = src[0];
...
inline Vector3f LCH2Lab(Vector3f src) {
  float a = src[2] * 3.14159265 / 180;
  return {src[0], src[1] * std::cos(a), src[1] * std::sin(a)};
}

inline Vector3f RGB2Lab(Vector3f src) {
  return XYZ2Lab(RGB2XYZ(src));
}

inline Vector3f Lab2RGB(Vector3f src) {
  return XYZ2RGB(Lab2XYZ(src));
}

inline Vector3f RGB2LCH(Vector3f src) {
  return Lab2LCH(RGB2Lab(src));
}

inline Vector3f LCH2RGB(Vector3f src) {
